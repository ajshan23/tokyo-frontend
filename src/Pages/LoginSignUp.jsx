...
const LoginSignUp = () => {
  ...
  const handleLogin = async () => {
    ...
    await axios.post(`${import.meta.env.VITE_BACKEND}/api/v1/users/login`,{ password: password, email: email })
      .then((response) =>{
  ...
  const handleSignup = async () => {
    ...
    setLoading(true);
    await axios.post(`${import.meta.env.VITE_BACKEND}/api/v1/users/register`,{
      username: username,
      password: password,
      email: email,
    })
